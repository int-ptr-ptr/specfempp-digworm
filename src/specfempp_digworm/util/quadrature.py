...
#     def __init__(self, degree_x: int, degree_z: int):
#         ngllxi = degree_x + 1
#         ngllga = degree_z + 1
...
#         # gll_polyderivs = np.zeros(
#         #     (ngll_capacity + 1, ngll_capacity, ngll_capacity - 1)
#         # )
#         # gll_knots = np.zeros((ngll_capacity + 1, ngll_capacity))
#         # for i in range(2, ngll_capacity + 1):
#         #     gll_weights[i, :i] = get_lagrange_weights(i - 1)
#         #     gll_knots[i, :i] = get_knots(i - 1)
#         #     L = np.array(build_lagrange_polys(i - 1))
#         #     gll_polys[i, :i, :i] = L
#         #     gll_polyderivs[i, :i, : i - 1] = np.array(polyderiv(L.T)).T
